...
namespace Asp_shopping_websiteDesign
{
    public partial class Asp_shopping_Order : System.Web.UI.Page
    {
        ...
        protected void dpQuantity_SelectedIndexChanged(object sender, EventArgs e)
        {
                ...
                double qty = Convert.ToDouble(dpQuantity.Text.ToString());
        ...
        protected void btnPlaceOrder_Click(object sender, EventArgs e)
        {
            ...
            if (res1 > 0)
            {
                ...
                cmdObj2 = new SqlCommand("stpOrderDetails", conObj1);
                cmdObj2.CommandType = CommandType.StoredProcedure;

                
                cmdObj2.Parameters.AddWithValue("@pCustomerid", Request.QueryString["cid"]);
                cmdObj2.Parameters.AddWithValue("@pProductid", Request.QueryString["ID"]);
                cmdObj2.Parameters.AddWithValue("@pTotalPrice", Convert.ToInt32(lblTotalPrice.Text));
                cmdObj2.Parameters.AddWithValue("@pTotalQuantity", Convert.ToInt32(dpQuantity.Text));
